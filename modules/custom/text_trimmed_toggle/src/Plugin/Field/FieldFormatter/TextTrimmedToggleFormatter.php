...
/**
 * @file
 * Contains \Drupal\filed_text_toggle\Plugin\Field\FieldFormatter\TextTrimmedToggleFormatter
 */

namespace Drupal\text_trimmed_toggle\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'text_trimmed_toggle' formatter.
 *
 * @FieldFormatter(
 *   id = "text_trimmed_toggle",
 *   label = @Translation("Trimmed Toggle"),
 *   field_types = {
 *     "text",
 *     "text_long",
 *     "text_with_summary"
 ...
 * )
 */
class TextTrimmedToggleFormatter extends FormatterBase {
  /**
   * {@inheritdoc}
   */
